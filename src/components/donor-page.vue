<template>
  <div class="hello">
    ...
    <body>
      ...
      <h1 style="color:white;">This is Donor Page</h1>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                 ...
                                 <div class="input-group">
                                    <label class="label">Name of Hospital</label>
                                    <input class="input--style-4" type="email" name="email">
                                </div>
                                <div class="input-group">
                                    <label class="label">Do you have case sheet from doctor?</label>
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">Yes
                                            <input type="radio" checked="checked" name="case-sheet">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">No
                                            <input type="radio" name="case-sheet">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">A+
                                            <input type="radio" checked="checked" name="blood-type">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container m-r-45 m-t-20
                                        ">A-
